...
var gutil = require("gulp-util"),
	removeUseStrict = require("../");

describe("gulp-remove-use-strict", function () {
	...
	it("should produce expected file via buffer", function (done) {
		...
		var stream = removeUseStrict();

		stream.on("error", function(err) {git
			should.exist(err);
			done(err);
		});
	...
	it("should produce expected file via stream", function (done) {
		...
		var stream = removeUseStrict("World");
